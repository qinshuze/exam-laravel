...
class PaperUpdateForm extends FormRequest
{
    public function rules()
    {
        $id = $this->route()->parameter('id');
        return [
            'title'          => ['max:255', Rule::unique('paper', 'title')->whereNot('id', $id)->whereNull('deleted_at')],
            'paper_type_id'  => ['integer', Rule::exists('paper_type', 'id')],
